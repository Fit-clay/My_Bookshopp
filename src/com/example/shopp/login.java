	        ...
	        box1.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
					...
					if(isChecked){
						...
						SharedPreferences shared=login.this.getSharedPreferences("login", MODE_PRIVATE);
						Editor editor=shared.edit();
						editor.putString("username", edt1.getText().toString().trim());
						editor.putString("userpasswd", edt2.getText().toString().trim());
						editor.commit();
					}
				}
			});
