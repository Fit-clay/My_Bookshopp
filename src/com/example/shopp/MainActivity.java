...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pro=(ProgressBar)findViewById(R.id.fristbar);
         
        
        
        mycache=new Mycache((int)Runtime.getRuntime().maxMemory()/8,mymap);

    	SharedPreferences shared=MainActivity.this.getSharedPreferences("login", MODE_PRIVATE);
		
    	if(!(shared.getString("username","one")==("one"))){
    		
    		System.out.println(shared.getString("username","one")+"aaaaaaaaaa");
    		User_name.setUserinfo_name(shared.getString("username","one"));
    		btn4.setVisibility(View.VISIBLE);
    	}else {
    		System.out.println(shared.getString("username","one")+"      aaaaaaaaaa");
    		System.out.println("sssssssssssssssss"+"aaaaaaaaaa");
